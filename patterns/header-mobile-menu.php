...
<!-- wp:site-title {"textAlign":"left","className":"site-title","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"},":hover":{"color":{"text":"var:preset|color|accent"}}}},"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"0px"},"margin":{"top":"0px","bottom":"0px","left":"0px","right":"0px"}}}} /--></div>
<!-- /wp:group -->

<!-- wp:navigation {"textColor":"secondary","overlayMenu":"always","icon":"menu","overlayBackgroundColor":"primary","overlayTextColor":"secondary","className":"main-nav","style":{"layout":{"flexSize":null},"typography":{"fontWeight":"500"}},"layout":{"type":"flex","orientation":"horizontal","justifyContent":"center","flexWrap":"wrap"}} /-->

<!-- wp:search {"showLabel":false,"buttonPosition":"button-only","buttonUseIcon":true,"isSearchFieldHidden":true,"className":"header-search"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
